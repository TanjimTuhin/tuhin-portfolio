...
const stats = [
  ...
  },
  {
    ...
    icon: <FaGitAlt />,
    suffix: "+",
    href: "https://github.com/TanjimTuhin",
    external: true,
  },
];
          ...
          {stats.map((item, index) => {
            const card = (
              <motion.div
                ...
                className="flex flex-col items-center justify-center gap-3 glass-strong px-8 py-8 rounded-2xl hover:glow-purple transition-all duration-300 min-w-[200px] group relative overflow-hidden cursor-pointer"
              >
                <motion.div
